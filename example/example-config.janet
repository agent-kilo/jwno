...
#
# If you're using a locale other than English, change this option to
# match your actual default virtual desktop names. E.g. for a Japanese
# locale, you may want to set it to "デスクトップ %d", so that the default
# names would match the ones generated by Windows, and look like
# "デスクトップ 1", "デスクトップ 2", "デスクトップ 3", etc. You can see
# your existing desktop names by pressing `Win + Tab`.
#
(put vd-man :default-desktop-name "Desktop %d")
